    ...
    <section class="w-full relative" >
        ...
        @include('partials.nav')
         <div class="absolute w-full bg-pabrik">
            <iframe class="py-12 sm:mt-12 mt-0" style="height:100vh; width:100%;" src="https://datastudio.google.com/embed/reporting/fddbcd6c-d607-47f8-ad85-8ac09679703b/page/5yczC"  frameborder="0" style="border:0" allowfullscreen></iframe>
