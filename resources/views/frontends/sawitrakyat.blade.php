    ...
    <section class="w-full relative" >
        ...
        @include('partials.nav')
         <div class="absolute w-full bg-pabrik">
            <iframe style="height:100vh; width:100%;" src="https://datastudio.google.com/embed/reporting/52470773-da14-4cdc-b8e5-4b337f8c8612/page/PuQxC"  frameborder="0" style="border:0" allowfullscreen></iframe>
