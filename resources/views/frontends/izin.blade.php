    ...
    <section class="w-full relative" >
        ...
        @include('partials.nav')
         <div class="absolute w-full bg-pabrik">
            <iframe class="sm:mt-12 mt-0 py-12" style="height:100vh; width:100%;" src="https://lookerstudio.google.com/embed/reporting/4028590d-f7fc-4c97-a226-d847e7fe492d/page/XdVvC"  frameborder="0" style="border:0" allowfullscreen></iframe>
