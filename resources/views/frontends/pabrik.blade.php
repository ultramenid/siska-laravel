    ...
    <section class="w-full relative" >
        ...
        @include('partials.nav')
         <div class="absolute w-full bg-pabrik">
            <iframe class="py-12 sm:mt-12 mt-0" style="height:100vh; width:100%;" src="https://datastudio.google.com/embed/reporting/d72b87aa-45b2-48c2-b9e2-315f98e5e41a/page/rTMvC" frameborder="0" style="border:0" allowfullscreen></iframe>
