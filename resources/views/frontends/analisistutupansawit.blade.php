    ...
    <section class="w-full relative" >
        ...
        @include('partials.nav')
         <div class="absolute w-full bg-pabrik">
            <iframe class="py-12 mt-4" style="height:100vh; width:100%;" src="https://datastudio.google.com/embed/reporting/71033252-d5e4-4ec2-8138-875a4e24ec3d/page/FAYxC" frameborder="0" style="border:0" allowfullscreen></iframe>
